...
/**
 *
订单状态:0:派单中;1:已接单;2:待支付;3:已完成;4:已取消;5:已电话解决;6:已退款;7:已评价;8:已支付;9:待验收;10:未接单;11:服务中;12:已过期;13:待确认
 */
define('PAY_STATUS_SENDORDERING',0);//派单中
define('PAY_STATUS_NO_PAY',2);//待支付
define('PAY_STATUS_PAY_COMPLETION',3);//已完成
define('PAY_STATUS_PAY_FAIL',4);//已取消
define('PAY_STATUS_PAY_PHONE_OVER',5);//已电话解决
define('PAY_STATUS_PAY_APPRAISE',7);//已评价
define('PAY_STATUS_PAY_SUCCESS',8);//已支付
