...
class CategoryModel extends Model
{
    ...
    protected $tableName = "supply_marketing_product_category";
...
//        $data = $this->create();
    ...
    {
        $list = $this->where($map)->field('id,name,pid,status,sort,icon_url,hot_icon_url,is_hot')->order('sort desc')->select();
        if (!$type) {
            return $list;
        }
