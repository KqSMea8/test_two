...
class PHPExcel_Chart_DataSeries
{
	...
	const GROUPING_CLUSTERED			= 'clustered';//聚合
	const GROUPING_STACKED				= 'stacked';//堆叠
	const GROUPING_PERCENT_STACKED		= 'percentStacked';//百分比堆栈
	const GROUPING_STANDARD				= 'standard';//标准
