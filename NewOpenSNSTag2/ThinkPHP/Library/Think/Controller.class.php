...
abstract class Controller
{
     ...
     * @return void
     */
    protected function success($message = '', $jumpUrl = '', $ajax = false,$formSubmit = "",$openNewUrl = "")
    {

        $this->dispatchJump($message, 1, $jumpUrl, $ajax,$formSubmit,$openNewUrl);
    }
     ...
     * @param string  $jumpUrl 页面跳转地址
     * @param mixed   $ajax 是否为Ajax方式 当数字时指定跳转时间
     * @param string $formSubmit 支付宝支付使用
     *
     * @access private
     * @return void
     */
    private function dispatchJump($message, $status = 1, $jumpUrl = '', $ajax = false,$formSubmit = "",$openNewUrl = "")
    {
        if (true === $ajax || IS_AJAX) {// AJAX提交
            ...
            $data['status'] = $status;
            $data['url'] = $jumpUrl;
            $data["formData"] = $formSubmit;
            $data["openNewUrl"] = $openNewUrl;
