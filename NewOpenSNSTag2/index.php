...
// 定义状态配置：生产环境:Reality 开发环境:Ceshi
//这里配置什么，TP就会加conf下什么配置文件
define('ENVIRONMENTSTATUS','Ceshi');

//判断环境
if(ENVIRONMENTSTATUS == 'Reality'){
    define('host_url','http://opensns.lz517.com');
}else{
    define('host_url','http://opensns.lz517.cn');
}
